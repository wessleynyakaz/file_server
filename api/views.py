from .serializers import ProfileImageSerializer, TeacherImageSerializer, BookImageSerializer ,AssignmentUploadSerializer, ComplaintUploadSerializer
...
class UploadTeacherImageView(APIView):
    parser_classes = (MultiPartParser, FormParser)
